...
layui.define('form', function(exports){
    ...
    Class.prototype.renderForm = function(type){
        form.render(type, 'LAY-protree-'+ this.index);
    };
    ...
    Class.prototype.operate = function(elem, item){
        ...
        entry.children('.layui-tree-btnGroup').on('click', '.layui-icon', function(e){
            ...
            //判断预先的操作吮吸，如果出现
            var beforeOperateFlag = false;
            if(options.beforeOperate){
                beforeOperateFlag = options.beforeOperate(type, returnObj) || false;
            }
            if(beforeOperateFlag){
                return false;
            }
